...
from kquant.pack.qsrt_candidates import CANDIDATE_POOL_SCHEMA_VERSION
...
MODE_VALIDATION_SUMMARY_KIND = (
    "kquant_kimi_k3_qsrt_mode_validation_summary"
)
...
def load_qsrt_mode_validation_scores(
    ...
    content_digest.update(b"kquant-qsrt-mode-validation-v2\0")
