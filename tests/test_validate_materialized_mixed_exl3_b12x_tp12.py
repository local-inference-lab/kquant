...
import scripts.validate_materialized_mixed_exl3_b12x_tp12 as validator
from scripts.validate_materialized_mixed_exl3_b12x_tp12 import (
...
@pytest.mark.parametrize(
    ...
    (
        ("mcg", "exl3_trellis_mcg", {"trellis_mcg": 0xCBAC1FED}),
        (
            "mul1-e4m3",
            "exl3_trellis_mul1_e4m3",
            {"trellis_mul1_e4m3": 0x83DCD12D},
        ),
...
def test_b12x_codebook_contract_rejects_unknown_codebook() -> None:
    with pytest.raises(ValueError, match="unsupported materialized EXL3 codebook"):
