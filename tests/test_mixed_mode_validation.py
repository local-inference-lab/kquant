...
import kquant.pack.mixed_mode_validation as mixed_mode_validation
...
from scripts.summarize_mixed_exl3_mode_validation import (
...
def test_mode_summary_loader_recomputes_and_requires_pass(
    ...
    loaded, loaded_scores = load_mixed_mode_validation_summary(
        path,
        pool,
        validation,
    )
    ...
    with pytest.raises(ValueError, match="does not reproduce"):
        load_mixed_mode_validation_summary(path, pool, validation)
