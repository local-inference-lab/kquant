#!/usr/bin/env python3
"""Validate a completed fixed-slab TP12 mixed-EXL artifact."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--verify-payloads",
        action="store_true",
        help="recompare every slab payload with its candidate or official source",
    )
    parser.add_argument(
...
def main() -> None:
    args = parse_args()
    report = validate_materialized_artifact(
        args.artifact,
