"""Aggregate controlled SQG-versus-MUL1 production-domain validation runs."""
...
def main() -> None:
    ...
    parser.add_argument("--baseline", default="mul1-e4m3")
    parser.add_argument("--candidate", default="sqg-normal-e4m3")
