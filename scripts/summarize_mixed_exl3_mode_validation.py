#!/usr/bin/env python3
"""Gate selected mixed-rate modes against matched R0 external encodes."""
...
def summarize(args: argparse.Namespace) -> dict[str, object]:
    ...
    selected_validation = load_mixed_validation_scores(
        args.validation_scores,
        pool,
    )
    mode_validation = load_mixed_mode_validation_scores(
